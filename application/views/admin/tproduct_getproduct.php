<div class="tab-pane fade" id="getproduct">

        <div class="panel panel-default">
          <p class="panel-heading">URL</p>
          <div class="panel-body">
            <pre>http://ec2-54-169-66-69.ap-southeast-1.compute.amazonaws.com/nail_care_svr/index.php/product/get_product_info</pre>
          </div>
        </div>
              ...
              <div class="col-md-5">
                <form>
                  <div class="form-group">
                    <label>产品id</label>
                    <input id="getproduct_pid" type="text" value="1" class="form-control"></div>
                </form>
                <div class="btn-toolbar list-toolbar">
                  <button id="getproduct_test" class="btn btn-primary">提交测试</button>
                </div>
              </div>
              <div class="col-md-9">
                <label>返回结果</label>
                <pre id="getproduct_result">无</pre>
              </div>
            </div>
          </div>
        </div>
